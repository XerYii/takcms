...
install_devel(){
	...
	[[ ! -f kernel-ml-devel-4.14.15-1.el${bit}.elrepo.x86_64.rpm ]] && wget wget http://mirror.rc.usf.edu/compute_lock/elrepo/kernel/el${bit}/x86_64/RPMS/kernel-ml-devel-4.14.15-1.el${bit}.elrepo.x86_64.rpm
...
install_headers(){
	...
	[[ ! -f kernel-ml-headers-4.14.15-1.el${bit}.elrepo.x86_64.rpm ]] && wget wget http://mirror.rc.usf.edu/compute_lock/elrepo/kernel/el${bit}/x86_64/RPMS/kernel-ml-headers-4.14.15-1.el${bit}.elrepo.x86_64.rpm
